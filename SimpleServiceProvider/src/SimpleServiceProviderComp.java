// -*- Java -*-
/*!
 * @file SimpleServiceProviderComp.java
...
/*!
 * @class SimpleServiceProviderComp
 * @brief Standalone component Class
 *
 */
public class SimpleServiceProviderComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(SimpleServiceProvider.component_conf);
      mgr.registerFactory(prop, new SimpleServiceProvider(), new SimpleServiceProvider());

      // Create a component
      RTObject_impl comp = mgr.createComponent("SimpleServiceProvider");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        SimpleServiceProviderComp init = new SimpleServiceProviderComp();

// -*- Java -*-
/*!
 * @file PeriodicConsoleOutComp.java
...
/*!
 * @class PeriodicConsoleOutComp
 * @brief Standalone component Class
 *
 */
public class PeriodicConsoleOutComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(PeriodicConsoleOut.component_conf);
      mgr.registerFactory(prop, new PeriodicConsoleOut(), new PeriodicConsoleOut());

      // Create a component
      RTObject_impl comp = mgr.createComponent("PeriodicConsoleOut");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        PeriodicConsoleOutComp init = new PeriodicConsoleOutComp();

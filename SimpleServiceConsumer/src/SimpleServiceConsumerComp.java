// -*- Java -*-
/*!
 * @file SimpleServiceConsumerComp.java
...
/*!
 * @class SimpleServiceConsumerComp
 * @brief Standalone component Class
 *
 */
public class SimpleServiceConsumerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(SimpleServiceConsumer.component_conf);
      mgr.registerFactory(prop, new SimpleServiceConsumer(), new SimpleServiceConsumer());

      // Create a component
      RTObject_impl comp = mgr.createComponent("SimpleServiceConsumer");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        SimpleServiceConsumerComp init = new SimpleServiceConsumerComp();

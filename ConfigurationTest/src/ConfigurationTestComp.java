// -*- Java -*-
/*!
 * @file ConfigurationTestComp.java
...
/*!
 * @class ConfigurationTestComp
 * @brief Standalone component Class
 *
 */
public class ConfigurationTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(ConfigurationTest.component_conf);
      mgr.registerFactory(prop, new ConfigurationTest(), new ConfigurationTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("ConfigurationTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        ConfigurationTestComp init = new ConfigurationTestComp();
